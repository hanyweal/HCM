...
namespace ExceptionNameSpace
{
    ...
    static class Message
    {
        public static string Msg(Exception ex)
        {
            ...
            {
                message = Resources.Globalization.DataIsNotRightText;
            }
            else
                message = "Error Message : " + Globals.Utilities.CombineListOfStrings(ex.Message, '\'') + " NewLine" + Resources.Globalization.ContactWithAdminText;
        ...
        private static string SqlExceptionMessages(Exception ex)
        {
            ...
            switch (sqlex.Number)
            {
                case -1:
                case 53:
                    return Resources.Globalization.NoConnectionWithDBServerText;
                case 2601:
                case 2627:
                    return Resources.Globalization.RecordAlreadyExistText;
                case 201:
                    return Resources.Globalization.ErrorInStoredProcedureText;
                case 547:
                    return Resources.Globalization.RecordRalatedWithOtherDataText;
                default:
                    return "Error Number : " + sqlex.Number + "NewLine" + Globals.Utilities.CombineListOfStrings(sqlex.Message.ToString(), '\'') + "NewLine" + Resources.Globalization.ContactWithAdminText;
            }
        }
    }
}