namespace HCMDAL
{
    public class PassengerOrdersOldDAL : CommonEntityDAL
    {
        ...
        //                PassengerOrderObj.DetailID = PassengerOrder.DetailID;
        ...
        //                                      //.Include("DelegationsDetails.EmployeesCareersHistory.EmployeesCodes.Employees")
        //                                      //.Where(x => x.DelegationsDetails.EmployeesCareersHistory.EmployeeCodeID.Equals(EmployeeCodeID))
        //                                      .ToList();
        ...
        //                         where pd.DetailID == p.DetailID && ech.EmployeeCodeID == EmployeeCodeID                             
        //                         select p);
        ...
        //    public PassengerOrders IsPassengerOrderAlreadyTook(int DetailID, int PassengerOrderTypeID)
        //    {
        //        try
        //        {
        //            var db = new HCMEntities();
        //            return db.PassengerOrders.SingleOrDefault(x => x.DetailID == DetailID && x.PassengerOrderTypeID == PassengerOrderTypeID);
        //        }
        //        catch
        //        {
        //            throw;
