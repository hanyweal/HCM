...
namespace HCMBLL
{
    public class MotherHoodVacationsBLL : BaseVacationsBLL
    {
        public override VacationsTypesEnum VacationType
        {
            get
            {
                return VacationsTypesEnum.MotherHood;
            }
        }
        ...
        public override Result Edit()
        {
            ...
            {
                // probation period = hiring date + 1 year
                DateTime ProbationEndDate = HiringRecord.JoinDate.AddYears(1).AddDays(-10);
                if (ProbationEndDate > this.VacationStartDate)
                {
                    result = new Result();
                    result.Entity = HiringRecord;
        ...
        {
            List<MotherHoodVacationsBLL> MotherHoodVacations = this.GetByEmployeeCodeVacationTypeNotCanceled(EmployeeCodeID, ExceptVacationID).Select(x => x as MotherHoodVacationsBLL).ToList();
