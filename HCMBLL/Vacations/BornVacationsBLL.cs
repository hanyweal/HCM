...
namespace HCMBLL
{
    public class BornVacationsBLL : BaseVacationsBLL
    {
        public override VacationsTypesEnum VacationType
        {
            get
            {
                return VacationsTypesEnum.Born;
            }
        }
        ...
        {
            List<BornVacationsBLL> BornVacations = this.GetByEmployeeCodeVacationTypeNotCanceled(EmployeeCodeID, ExceptVacationID).Select(x => x as BornVacationsBLL).ToList();
            return BornVacations.Sum(x => x.VacationPeriod);
        }
    }
}
