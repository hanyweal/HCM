...
namespace HCMBLL
{
    public class BirthVacationsBLL : BaseVacationsBLL
    {
        public override VacationsTypesEnum VacationType
        {
            get
            {
                return VacationsTypesEnum.Birth;
            }
        }
        ...
        {
            List<BirthVacationsBLL> BirthVacations = this.GetByEmployeeCodeVacationTypeNotCanceled(EmployeeCodeID, ExceptVacationID).Select(x => x as BirthVacationsBLL).ToList();
            return BirthVacations.Sum(x => x.VacationPeriod);
        }
    }
}
